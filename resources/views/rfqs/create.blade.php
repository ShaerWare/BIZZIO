                ...
                <form method="POST" action="{{ route('rfqs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <label class="flex items-start">
                            ...
                            <span class="ml-2 text-sm text-gray-700">
                                Я уведомлён, что процедура проведения Запроса цен не является публичной офертой и не обязывает к заключению договора. Организатор вправе отменить процедуру на любом этапе без объяснения причин.
                            </span>
                        </label>
                    </div>
