        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('companies.update', $company) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <!-- Новый логотип -->
                    <div>
                        <x-avatar-cropper name="logo" :label="$company->logo ? 'Заменить логотип' : 'Логотип'" hint="JPG, PNG. Максимум 2MB. Можно приблизить и обрезать." />
                    </div>
                    ...
                    <div>
                        <x-pdf-documents-input
                            ...
                            hint="Не более 10 файлов, общий объём — до 10 МБ (с учётом уже загруженных)" />
                    </div>
