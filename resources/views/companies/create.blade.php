...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500">Создание компании</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h1 class="text-2xl font-bold text-gray-900 mb-6">Создание компании</h1>
                ...
                <form method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="legal_form" 
                            ...
                            <option value="ПАО" {{ old('legal_form') == 'ПАО' ? 'selected' : '' }}>ПАО</option>
                            <option value="ИП" {{ old('legal_form') == 'ИП' ? 'selected' : '' }}>ИП</option>
                            <option value="ЗАО" {{ old('legal_form') == 'ЗАО' ? 'selected' : '' }}>ЗАО</option>
                        </select>
                        @error('legal_form')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <x-pdf-documents-input
                            label="Документы (PDF)"
                            hint="Устав, ИНН, ОГРН и другие документы. Не более 10 файлов, общий объём — до 10 МБ" />
                    </div>
