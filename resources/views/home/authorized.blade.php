...
<div data-v26-root data-auth-state="authorized">
    ...
    {{-- ======================= MOBILE ======================= --}}
    <div id="bizzio-mobile-v1">
        <div class="page" data-panel="none">
            <header class="bz-header">
                <a href="{{ route('home') }}"><img class="bz-logo" src="/images/bizzio_horizontal_logo_color_whitebg.svg" alt="Bizzio"></a>
                <a class="bz-icon-btn" href="{{ route('notifications.index') }}" aria-label="Уведомления"><svg><use href="#bell"/></svg></a>
                <button class="bz-icon-btn" type="button" data-panel-toggle="services" aria-label="Сервисы"><svg><use href="#grid"/></svg></button>
                <button class="bz-icon-btn" type="button" data-panel-toggle="menu" aria-label="Меню"><svg><use href="#menu"/></svg></button>
            </header>

            <main class="bz-main">
                <section class="bz-card">
                    <a class="bz-shortcut" href="{{ route('users.show', $viewer) }}">
                        <span class="photo header"><img src="{{ $viewer->avatar_url }}" alt=""></span>
                        <span>
                            <span class="name">{{ $viewer->full_name }}</span>
                            <span class="bz-meta">{{ $viewer->position ?: 'Участник Bizzio' }}</span>
                        </span>
                    </a>
                </section>

                <section class="bz-card">
                    <h2 class="bz-card-title">Сервисы</h2>
                    <div class="bz-service-grid">
                        <a class="bz-service-tile" href="{{ route('tenders.index') }}"><svg><use href="#gavel"/></svg><span>Закупки</span></a>
                        <a class="bz-service-tile" href="{{ route('companies.index') }}"><svg><use href="#building"/></svg><span>Компании</span></a>
                        <a class="bz-service-tile" href="{{ route('projects.index') }}"><svg><use href="#clip"/></svg><span>Проекты</span></a>
                        <a class="bz-service-tile" href="{{ route('friends.index') }}"><svg><use href="#users"/></svg><span>Контакты</span></a>
                        <a class="bz-service-tile" href="{{ route('news.index') }}"><svg><use href="#news"/></svg><span>Новости</span></a>
                    </div>
                </section>

                <section class="bz-card">
                    <h2 class="bz-card-title">Мои закупки</h2>
                    @forelse($myTenders as $tender)
                        <a class="bz-event" href="{{ $tender['url'] }}">
                            <div class="bz-event-icon"><svg><use href="#gavel"/></svg></div>
                            <div>
                ...
                <section class="bz-card">
                    <h2 class="bz-card-title">Лента</h2>
                    @forelse($recentPosts as $post)
                        <div class="bz-post">
                ...
                <section class="bz-card">
                    <h2 class="bz-card-title">Новости</h2>
                    @forelse($latestNews as $item)
            ...
            <nav class="bz-bottom" aria-label="Основная навигация">
                <a class="bz-bottom-item active" href="{{ route('home') }}"><svg><use href="#auth-home"/></svg><span>Главная</span></a>
                ...
                <a class="bz-bottom-item" href="{{ route('news.index') }}"><svg><use href="#news"/></svg><span>Новости</span></a>
            ...
            <aside class="auth-drawer auth-menu-drawer" aria-label="Меню">
                ...
                <a class="auth-menu-row" href="{{ route('tenders.my') }}"><svg><use href="#gavel"/></svg><span>Мои закупки</span></a>
                <a class="auth-menu-row" href="{{ route('tenders.invitations.my') }}"><svg><use href="#clip"/></svg><span>Мои приглашения</span></a>
                <a class="auth-menu-row" href="{{ route('tenders.bids.my') }}"><svg><use href="#file"/></svg><span>Мои заявки</span></a>
                <a class="auth-menu-row" href="{{ route('profile.edit') }}"><svg><use href="#auth-settings"/></svg><span>Настройки профиля</span></a>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button class="auth-menu-row" type="submit"><svg><use href="#auth-logout"/></svg><span>Выйти</span></button>
                </form>
            </aside>
