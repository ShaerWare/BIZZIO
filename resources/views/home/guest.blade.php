    ...
    <div id="bizzio-mobile-v1">
        <div class="page" data-panel="none">
            <header class="bz-header gm-header">
                ...
                <a class="bz-icon-btn" href="{{ $authUrl }}" aria-label="Войти"><svg><use href="#guest-user"/></svg></a>
            ...
            <main class="bz-main">
                <section class="bz-card gm-welcome">
                    <h1>Добро пожаловать в Bizzio!</h1>
                ...
                <section class="bz-card">
                    ...
                    <div class="bz-service-grid">
                        ...
                        <a class="bz-service-tile" href="{{ route('tenders.index') }}"><img class="procurement-icon" src="/images/v26/bizzio-quick-icon-procurement-base-v5.png" alt=""><span>Закупки</span></a>
                        <a class="bz-service-tile" href="{{ route('news.index') }}"><svg><use href="#news"/></svg><span>Новости</span></a>
                        <a class="bz-service-tile" href="{{ $registerUrl }}"><svg><use href="#users"/></svg><span>Контакты</span></a>
                    </div>
                </section>

                <section class="bz-card">
                    <h2 class="bz-card-title">Какой сервис запустить следующим?</h2>
                ...
                <section class="bz-card">
                    <h2 class="bz-card-title">Актуальное в Bizzio</h2>
                    @forelse($events as $event)
                        <a class="bz-event" href="{{ $event['url'] }}">
                            <div class="bz-event-icon"><svg><use href="#clip"/></svg></div>
                            <div>
                                <div class="bz-event-title">{{ $event['title'] }}</div>
            ...
            <nav class="bz-bottom" aria-label="Основная навигация">
                <a class="bz-bottom-item active" href="{{ route('home') }}"><svg><use href="#guest-home"/></svg><span>Главная</span></a>
            ...
            <aside class="guest-drawer guest-menu-drawer" aria-label="Меню">
                ...
                <div class="guest-menu-list">
                    <a class="guest-menu-row" href="{{ route('companies.index') }}"><svg><use href="#building"/></svg><span>Компании</span></a>
                    <a class="guest-menu-row" href="{{ route('projects.index') }}"><svg><use href="#clip"/></svg><span>Проекты</span></a>
                    <a class="guest-menu-row" href="{{ route('tenders.index') }}"><svg><use href="#gavel"/></svg><span>Закупки</span></a>
                    <a class="guest-menu-row" href="{{ route('news.index') }}"><svg><use href="#news"/></svg><span>Новости</span></a>
                </div>
                <div class="guest-menu-actions">
                    <a class="guest-login" href="{{ $authUrl }}">Войти</a>
