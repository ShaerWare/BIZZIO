                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center text-gray-600">
                            ...
                            <span>Создатель: <strong>{{ $auction->creator->full_name }}</strong></span>
                    ...
                    <div class="w-full md:w-96">
                        ...
                        {{-- #193 Приглашение сторонней (незарегистрированной) компании — готовый текст.
                             Организатору — пока идёт приём заявок, остальным — только у открытой процедуры. --}}
                        @if($auction->canBeSharedBy(auth()->user()))
