<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Мои приглашения в закрытые аукционы') }}
        </h2>
    </x-slot>
                                    ...
                                    @foreach($invitations as $invitation)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @else
                                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">{{ ucfirst($auction->status) }}</span>
                                                @endif
                                            </td>
