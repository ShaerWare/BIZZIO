...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-gray-600">Информация о процедурах запроса цен и аукционов на платформе Bizzio</p>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 space-y-8">
                ...
                <section>
                    ...
                    <div class="prose prose-sm text-gray-700 space-y-2">
                        ...
                        <ul class="list-disc pl-5 space-y-1">
                            <li><strong>Запрос цен (RFQ)</strong> — процедура выбора поставщика на основе комплексной оценки по нескольким критериям (цена, срок, условия оплаты).</li>
                ...
                {{-- 2. Запрос цен --}}
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 mb-3">2. Запрос цен (RFQ)</h2>
                    <div class="prose prose-sm text-gray-700 space-y-2">
                        <h3 class="text-lg font-medium text-gray-800">Этапы проведения</h3>
                        <ol class="list-decimal pl-5 space-y-1">
                            <li>Организатор создаёт запрос цен с описанием, техническим заданием и критериями оценки.</li>
