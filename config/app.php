...
return [
    ...
    */
    ...
    /*
     * #181 Адреса входа и регистрации. ТЗ требует хранить их в конфигурации, а не зашивать
     * в компоненты: новая главная — единая точка входа, и адрес авторизации может измениться.
     */
    'auth_url' => env('AUTH_URL', '/login'),
    'register_url' => env('REGISTER_URL', '/register'),
