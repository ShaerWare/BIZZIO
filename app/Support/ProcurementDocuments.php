...
final class ProcurementDocuments
{
    ...
    /**
     * #185 Сбросить временные файлы при «чистом» открытии формы создания/редактирования.
     *
     * Восстанавливать документы нужно только после ошибки валидации (redirect back с old input).
     * Без этой очистки файлы недоделанной процедуры «прилипали» к следующей — пользователь
     * открывал пустую форму, а в ней уже были приложены документы прошлой попытки.
     */
    public static function clearTempOnFreshForm(): void
    {
